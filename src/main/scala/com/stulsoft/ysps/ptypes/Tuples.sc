...
object Tuples {
	...
	// Define a tuple
  private val t1 = (1, false, "Scala") //> t1  : (Int, Boolean, String) = (1,false,Scala)
	...
	// Define tuple
  private val t2 = "title" -> "Begining Scala" //> t2  : (String, String) = (title,Begining Scala)
	
	// Define a tuple with tuple inside
  private val t3 = 1 -> "more" -> true //> t3  : ((Int, String), Boolean) = ((1,more),true)
