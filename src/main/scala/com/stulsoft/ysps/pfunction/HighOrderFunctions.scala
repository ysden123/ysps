...
object HighOrderFunctions {
  ...
  /**
    ...
    */
  private def mulBy(factor: Double) = (x: Double) => factor * x
  ...
  /**
    ...
    * @return the multiply function
    */
  private def mulBy2(factor: Double): Double => Double = (x: Double) => factor * x
}